...
return [
    ...
    'columns' => [
        ...
        'title' => [
            'label' => 'LLL:EXT:faq/Resources/Private/Language/locallang_be.xlf:tx_faq_domain_model_questioncategory.title',
            'config' => [
                'type' => 'input',
                'eval' => 'trim',
            ],
        ...
        'parent' => [
            'label' => 'LLL:EXT:faq/Resources/Private/Language/locallang_be.xlf:tx_faq_domain_model_questioncategory.parent',
            'config' => [
                'type' => 'select',
        ...
        'description' => [
            'label' => 'LLL:EXT:faq/Resources/Private/Language/locallang_be.xlf:tx_faq_domain_model_questioncategory.description',
            'config' => [
                'type' => 'text',
                'cols' => 30,
                'rows' => 5,
