...
class VoteController extends AbstractWidgetController
{
    ...
    public function voteAction(Question $question, $mode)
    {
        ...
        try {
            ...
            $result['state'] = 'OK';
            $result['description'] = TranslateUtility::assureLabel('eid.ok', 'hdnet_faq', 'Vielen Dank f&uuml;r Ihre Wertung.');
            $result['currentCounter'] = $vote->getQuestionVotes();
        } catch (AlreadyVotedException $e) {
            $result['description'] = TranslateUtility::assureLabel('eid.error.multivote', 'hdnet_faq', 'Sie haben f&uuml;r diese Frage bereits abgestimmt!');
